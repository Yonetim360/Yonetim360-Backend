...
{
    public class GetAnnouncementByIdQueryHandler : IQueryHandler<GetAnnouncementByIdQuery, ReadAnnouncementDto>
    {
        ...
        public async Task<ReadAnnouncementDto> Handle(GetAnnouncementByIdQuery request, CancellationToken cancellationToken)
        {
           ...
           return _mapper.Map<ReadAnnouncementDto>(query);
        }
    }
}
