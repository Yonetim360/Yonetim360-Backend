...
{
    public class GetCrmSolutionRequestsQueryHandler : IQueryHandler<GetCrmSolutionRequestsQuery, List<ReadCrmSolutionRequestDto>>
    {
        ...
        public async Task<List<ReadCrmSolutionRequestDto>> Handle(GetCrmSolutionRequestsQuery request, CancellationToken cancellationToken)
        {
            ...
            return _mapper.Map<List<ReadCrmSolutionRequestDto>>(query);
        }
    }
}
