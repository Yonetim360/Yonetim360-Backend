...
{
    public class GetRepresentativesQueryHandler : IQueryHandler<GetRepresentativesQuery, List<RepresentativeDto>>
    {
        ...
        public async Task<List<RepresentativeDto>> Handle(GetRepresentativesQuery request, CancellationToken cancellationToken)
        {
           ...
           return _mapper.Map<List<RepresentativeDto>>(representatives.ToList());
        }
    }
}
