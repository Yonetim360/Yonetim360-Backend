...
{
    public class GetCustomersQueryHandler : IQueryHandler<GetCustomersQuery, List<ReadCustomerDto>>
    {
        ...
        public async Task<List<ReadCustomerDto>> Handle(GetCustomersQuery request, CancellationToken cancellationToken)
        {
            ...
            var result = _mapper.Map<List<ReadCustomerDto>>(customerList);
            return result;
        }
    }
}
